...
const en = {
  ...
  'meta.imageAlt': 'PATON haptic glove by FELYA with the claim Your hands. Anywhere on Earth.',
  'brand.home': 'FELYA home',
  ...
  'hero.imageAlt': 'Close-up of the FELYA haptic glove with blue finger mechanisms over a fabric glove.',
  ...
  'developmentUpdates.error': 'Something went wrong. Email us at info@felya.com and we will add you manually.',
  ...
  'footer.github': 'FELYA on GitHub',
  'footer.youtube': 'FELYA prototype video on YouTube',
...
const de: TranslationDictionary = {
  ...
  'meta.imageAlt': 'PATON Haptikhandschuh von FELYA mit dem Satz Deine Hände. Überall auf der Welt.',
  'brand.home': 'FELYA Startseite',
  ...
  'hero.imageAlt': 'Nahaufnahme des haptischen FELYA Handschuhs mit blauer Fingermechanik auf einem Stoffhandschuh.',
  ...
  'developmentUpdates.success': 'Verbindung hergestellt. Du bist auf der Liste.', 'developmentUpdates.error': 'Das hat nicht geklappt. Schreib uns an info@felya.com, dann tragen wir dich manuell ein.',
  ...
  'footer.legalAria': 'Rechtliche Informationen', 'footer.linkedin': 'FELYA auf LinkedIn', 'footer.instagram': 'FELYA auf Instagram', 'footer.github': 'FELYA auf GitHub', 'footer.youtube': 'FELYA Prototypenfilm auf YouTube',
...
const ky: TranslationDictionary = {
  ...
  'meta.imageAlt': 'FELYA компаниясынын PATON тактилдик мээлейи жана «Колдоруң. Дүйнөнүн каалаган жеринде.» деген билдирүү.',
  'brand.home': 'FELYA башкы бети',
  ...
  'hero.imageAlt': 'Кездеме мээлейдин үстүндөгү көк манжа механизмдери бар FELYA тактилдик мээлейинин жакын көрүнүшү.',
  ...
  'developmentUpdates.emailLabel': 'Электрондук почта', 'developmentUpdates.placeholder': 'Электрондук почта', 'developmentUpdates.button': 'Жаңылыктарды алуу', 'developmentUpdates.pendingButton': 'Жөнөтүлүүдө...', 'developmentUpdates.pendingStatus': 'Катталууда...', 'developmentUpdates.fallbackButton': 'Жаңылыктарды алуу', 'developmentUpdates.success': 'Байланыш түзүлдү. Сиз тизмедесиз.', 'developmentUpdates.error': 'Ката кетти. info@felya.com дарегине жазыңыз, биз сизди кол менен кошобуз.',
...
const id: TranslationDictionary = {
  ...
  'hero.headlineHands': 'Tangan Anda.', 'hero.headlineAnywhere': 'Di mana pun di dunia.', 'hero.lead': 'Gerakan alami. Umpan balik nyata.', 'hero.languageInteraction': 'Tampilkan bahasa berikutnya', 'hero.imageAlt': 'Tampilan dekat sarung tangan haptik FELYA dengan mekanisme jari biru di atas sarung tangan berbahan kain.',
...
const ko: TranslationDictionary = {
  ...
  'hero.headlineHands': '당신의 두 손.', 'hero.headlineAnywhere': '세계 어디에서나.', 'hero.lead': '자연스러운 움직임. 생생한 피드백.', 'hero.languageInteraction': '다음 언어 보기', 'hero.imageAlt': '패브릭 글러브 위에 파란색 손가락 메커니즘이 장착된 FELYA 햅틱 글러브의 클로즈업.',
...
const ja: TranslationDictionary = {
  ...
  'hero.headlineHands': 'あなたの手を。', 'hero.headlineAnywhere': '世界のどこへでも。', 'hero.lead': '自然な動き。確かな感覚。', 'hero.languageInteraction': '次の言語を表示', 'hero.imageAlt': '布製グローブの上に青い指機構を備えたFELYAハプティックグローブのクローズアップ。',
...
const zhCn: TranslationDictionary = {
  ...
  'hero.headlineHands': '你的双手。', 'hero.headlineAnywhere': '遍及世界。', 'hero.lead': '自然动作。真实反馈。', 'hero.languageInteraction': '显示下一种语言', 'hero.imageAlt': 'FELYA 触觉手套的特写：织物手套上装有蓝色手指机构。',
...
const zhTw: TranslationDictionary = {
  ...
  'hero.headlineHands': '你的雙手。', 'hero.headlineAnywhere': '世界任何角落。', 'hero.lead': '自然動作。真實回饋。', 'hero.languageInteraction': '顯示下一種語言', 'hero.imageAlt': 'FELYA 觸覺手套特寫：織物手套上裝有藍色手指機構。',
...
const ru: TranslationDictionary = {
  ...
  'meta.imageAlt': 'Тактильная перчатка PATON от FELYA и слоган «Ваши руки. В любой точке мира».',
  'brand.home': 'Главная страница FELYA',
  ...
  'hero.imageAlt': 'Крупный план тактильной перчатки FELYA с синими механизмами пальцев поверх тканевой основы.',
  ...
  'developmentUpdates.error': 'Что-то пошло не так. Напишите нам на info@felya.com, и мы добавим вас вручную.',
  ...
  'footer.github': 'FELYA на GitHub',
  'footer.youtube': 'Видео прототипа FELYA на YouTube',
...
const pt: TranslationDictionary = {
  ...
  'meta.imageAlt': 'Luva háptica PATON da FELYA com a frase As suas mãos. Em qualquer lugar do mundo.',
  'brand.home': 'Página inicial da FELYA',
  ...
  'hero.imageAlt': 'Vista aproximada da luva háptica da FELYA, com mecanismos azuis sobre uma luva de tecido.',
  ...
  'developmentUpdates.error': 'Algo correu mal. Escreva-nos para info@felya.com e faremos a inscrição manualmente.',
  ...
  'footer.github': 'FELYA no GitHub',
  'footer.youtube': 'Vídeo do protótipo FELYA no YouTube',
...
const fr: TranslationDictionary = {
  ...
  'meta.imageAlt': 'Le gant haptique PATON de FELYA avec la promesse Vos mains. Partout dans le monde.',
  'brand.home': 'Accueil FELYA',
  ...
  'hero.imageAlt': 'Gros plan sur le gant haptique FELYA, avec ses mécanismes de doigts bleus montés sur un gant textile.',
  ...
  'developmentUpdates.error': 'Un problème est survenu. Écrivez-nous à info@felya.com et nous vous ajouterons manuellement.',
  ...
  'footer.github': 'FELYA sur GitHub',
  'footer.youtube': 'Vidéo du prototype FELYA sur YouTube',
...
const es: TranslationDictionary = {
  ...
  'meta.imageAlt': 'Guante háptico PATON de FELYA con la frase Tus manos. En cualquier lugar del mundo.',
  'brand.home': 'Página de inicio de FELYA',
  ...
  'hero.imageAlt': 'Primer plano del guante háptico de FELYA, con mecanismos azules sobre un guante de tejido.',
  ...
  'developmentUpdates.error': 'Algo ha fallado. Escríbenos a info@felya.com y te añadiremos manualmente.',
  ...
  'footer.github': 'FELYA en GitHub',
  'footer.youtube': 'Vídeo del prototipo de FELYA en YouTube',
...
const it: TranslationDictionary = {
  ...
  'meta.imageAlt': 'Il guanto aptico PATON di FELYA con il messaggio Le tue mani. Ovunque sulla Terra.',
  'brand.home': 'Pagina iniziale di FELYA',
  ...
  'hero.imageAlt': 'Primo piano del guanto aptico di FELYA, con meccanismi blu per le dita montati su un guanto in tessuto.',
  ...
  'developmentUpdates.error': 'Qualcosa non ha funzionato. Scrivici a info@felya.com e ti aggiungeremo manualmente.',
  ...
  'footer.github': 'FELYA su GitHub',
  'footer.youtube': 'Filmato del prototipo FELYA su YouTube',
